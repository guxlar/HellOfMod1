#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\WorldWeather.c"
#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\WorldDateTime.c"
#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\SpawnObject.c"
#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\BridgePrisonIsland.c"
#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\BridgeSkalistyIsland.c"
#include "$CurrentDir:mpmissions\\GuxlarMission1.ChernarusPlus\\code\\Lighthouses.c"
